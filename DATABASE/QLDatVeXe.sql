...
CREATE TABLE CHUYENXE (
    ...
    trangThai NVARCHAR(20)  DEFAULT N'SAPDI'
        CHECK (trangThai IN (N'SAPDI', N'DANGDI', N'HOANTHANH', N'HOAN', N'HUY')),
...
CREATE TABLE DONDATVE (
    ...
    trangThai NVARCHAR(20)  DEFAULT N'CHOXULY'
        CHECK (trangThai IN (N'CHOXULY', N'DAHUY', N'THANHCONG',  N'BOCHUYEN')),
	tennguoidi nvarchar(100) null,
	sdtnguoidi varchar(12) null,
    ghiChu    NVARCHAR(255),
...
('T28', N'Bình Dương', '33.jpg'), ('T29', N'Bình Thuận', '6.jpg'), ('T30', N'Gia Lai', '22.jpg'),
('T31', N'Kiên Giang', '10.jpg'), ('T32', N'Cần Thơ', '5.jpg'), ('T33', N'Đồng Nai', '1.jpg'),
('T34', N'An Giang', '34.jpg');
GO
...
('51B-115.00', 'NX02', N'Cung điện di động', 'Hyundai', 2023, 2, N'SANSANG', 'x24.jpg'),
...
('CX01', 'TD01', '50E-802.84', '2026-05-19', '15:00', 850000, N'SAPDI'),
('CX02', 'TD02', '51B-115.00', '2026-05-21', '19:00', 900000, N'SAPDI'), -- [FIX] Sửa 115.01 thành 115.00
('CX03', 'TD01', '38B-012.42', '2026-05-21', '07:00', 750000, N'SAPDI'),

-- Tuyến TP.HCM - Đà Lạt (TD03, TD04)
('CX04', 'TD03', '49F-005.76', '2026-05-21', '08:00', 300000, N'SAPDI'),
('CX05', 'TD04', '60B-034.21', '2026-05-21', '22:00', 350000, N'SAPDI'),
('CX06', 'TD03', '51B-296.17', '2026-05-22', '12:00', 320000, N'SAPDI'),

-- Tuyến TP.HCM - Đà Nẵng (TD05, TD06)
('CX07', 'TD05', '72B-004.56', '2026-05-22', '09:00', 450000, N'SAPDI'),
('CX08', 'TD06', '65B-003.44', '2026-05-22', '15:30', 450000, N'SAPDI'),

-- Tuyến Limousine VIP / Tuyến ngắn (TD07, TD08, TD09, TD11)
('CX09', 'TD08', '29B-555.99', '2026-05-22', '05:00', 250000, N'SAPDI'),
('CX10', 'TD07', '49F-005.75', '2026-05-22', '13:00', 380000, N'SAPDI'),
('CX11', 'TD09', '15B-999.01', '2026-05-23', '06:30', 400000, N'SAPDI'), -- [FIX] Sửa 15B-009.01 thành 15B-999.01
('CX12', 'TD11', '47B-111.22', '2026-05-23', '21:00', 420000, N'SAPDI'),
('CX13', 'TD08', '30F-999.13', '2026-05-23', '14:00', 280000, N'SAPDI'),
('CX14', 'TD09', '16B-637.74', '2026-05-23', '08:00', 350000, N'SAPDI'),
('CX15', 'TD11', '29B-888.18', '2026-05-23', '23:00', 450000, N'SAPDI'),

-- Các xe còn lại chạy các tuyến bổ sung
('CX16', 'TD10', '53S-8471',   '2026-05-24', '20:00', 220000, N'SAPDI'),
('CX17', 'TD12', '60B-034.21', '2026-05-24', '10:00', 500000, N'SAPDI'), -- [FIX] Sửa biển 222.33 ảo thành 60B-034.21
('CX18', 'TD01', '50B-111.04', '2026-05-24', '18:00', 700000, N'SAPDI'),
('CX19', 'TD02', '17B-002.11', '2026-05-24', '19:00', 700000, N'SAPDI'),
('CX20', 'TD03', '43B-002.77', '2026-05-25', '08:00', 250000, N'SAPDI'),
('CX21', 'TD05', '18B-007.89', '2026-05-25', '14:00', 480000, N'SAPDI'),
('CX22', 'TD09', 'XE-INT-03',  '2026-05-25', '21:00', 600000, N'SAPDI'), -- [FIX] Sửa biển 24B ảo thành XE-INT-03
('CX23', 'TD04', 'XE-INT-01',  '2026-05-25', '22:00', 300000, N'SAPDI'),
('CX24', 'TD13', '15B-999.01', '2026-05-25', '07:00', 300000, N'SAPDI'), -- [FIX] Sửa 009.01 thành 999.01
('CX25', 'TD14', '16B-637.74', '2026-05-26', '20:00', 350000, N'SAPDI'),
('CX26', 'TD15', 'XE-INT-03',  '2026-05-26', '22:00', 450000, N'SAPDI'), -- [FIX] Sửa biển 24B ảo thành XE-INT-03

-- Các tuyến Tây Nguyên
('CX27', 'TD17', '60B-034.21', '2026-05-26', '08:30', 400000, N'SAPDI'), -- [FIX] Sửa biển 222.33 ảo thành 60B-034.21
('CX28', 'TD18', '18B-007.89', '2026-05-26', '09:00', 200000, N'SAPDI'),
('CX29', 'TD19', '51B-296.17', '2026-05-26', '14:00', 250000, N'SAPDI'),

-- Các tuyến Miền Nam & Miền Tây
('CX30', 'TD20', '29B-888.18', '2026-05-27', '15:00', 180000, N'SAPDI'),
('CX31', 'TD21', '43B-002.77', '2026-05-27', '05:00', 220000, N'SAPDI'),
('CX32', 'TD22', '17B-002.11', '2026-05-27', '06:00', 150000, N'SAPDI'),

-- Các tuyến bổ sung cho xe nội thất đặc biệt
('CX33', 'TD23', 'XE-INT-02', '2026-05-28', '18:00', 300000, N'SAPDI'),
('CX34', 'TD24', 'XE-INT-01', '2026-05-28', '13:00', 280000, N'SAPDI'),
('CX35', 'TD01', '50E-802.84', '2026-05-18', '15:00', 850000, N'SAPDI'),
('CX36', 'TD02', '51B-115.00', '2026-05-18', '19:00', 900000, N'SAPDI'), 
('CX37', 'TD01', '38B-012.42', '2026-05-18', '07:00', 750000, N'SAPDI');
GO
...
============================================================= */
INSERT INTO DONDATVE (maDon, maKH, maNV, ngayDat, tongTien, tienCoc, trangThai, ghiChu, tennguoidi, sdtnguoidi) VALUES 
('DON01', 'KH01', 'NV01', '2026-06-10 08:00', 850000, 850000, N'THANHCONG', N'Khách đi 1 người - Limousine VIP', N'Nguyễn Văn An', '0901234567'),
('DON02', 'KH02', 'NV01', '2026-06-10 09:15', 600000, 300000, N'CHOXULY',   N'Khách đi 2 người - Giường nằm - Cọc 50%', N'Trần Thị Bình', '0912345678'),
('DON03', 'KH03', 'NV03', '2026-06-10 10:30', 1350000, 1350000, N'THANHCONG', N'Khách đoàn 3 người - Ghế ngồi Samco', N'Lê Quang Cường', '0923456789'),
('DON04', 'KH04', NULL,   '2026-06-10 14:00', 250000, 0,      N'CHOXULY',   N'Đặt 1 ghế qua App', N'Phạm Minh Đức', '0934567890'),
('DON05', 'KH01', 'NV02', '2026-06-10 15:45', 1700000, 1700000, N'THANHCONG', N'Cặp đôi đặt 2 phòng VIP', N'Nguyễn Văn An', '0901234567'),
('DON06', 'KH06', 'NV03', '2026-06-10 16:20', 380000, 380000, N'THANHCONG', N'Khách đi 1 người - Solati', N'Đỗ Hùng Dũng', '0956789012'),
('DON07', 'KH07', NULL,   '2026-06-10 20:00', 900000, 450000, N'CHOXULY',   N'Đặt 3 ghế - Giường nằm', N'Vũ Tuyết Mai', '0967890123'),
('DON08', 'KH01', 'NV01', '2026-05-15 08:00', 850000, 850000, N'THANHCONG', N'Bổ sung data đánh giá', N'Nguyễn Văn An', '0901234567'),
('DON09', 'KH02', 'NV02', '2026-05-15 09:30', 850000, 850000, N'THANHCONG', N'Bổ sung data đánh giá', N'Trần Thị Bình', '0912345678'),
('DON10', 'KH03', 'NV03', '2026-05-16 10:00', 900000, 900000, N'THANHCONG', N'Bổ sung data đánh giá', N'Lê Quang Cường', '0923456789'),
('DON11', 'KH04', NULL,   '2026-05-16 11:15', 900000, 900000, N'THANHCONG', N'Đặt qua app', N'Phạm Minh Đức', '0934567890'),
('DON12', 'KH05', NULL,   '2026-05-16 14:20', 900000, 900000, N'THANHCONG', N'Đặt qua app', N'Hoàng Lan Anh', '0945678901'),
('DON13', 'KH06', 'NV01', '2026-05-17 09:00', 750000, 750000, N'THANHCONG', N'Bổ sung data đánh giá', N'Đỗ Hùng Dũng', '0956789012'),
('DON14', 'KH07', NULL,   '2026-05-17 15:30', 750000, 750000, N'THANHCONG', N'Đặt qua app', N'Vũ Tuyết Mai', '0967890123');
GO
...
INSERT INTO CHITIETDATVE (maCTDat, maDon, maChuyen, maGhe, giaVeLucDat, trangThaiVe) VALUES 
('CT08', 'DON05', 'CX02', 'G103', 850000, N'DASUDUNG'),
('CT09', 'DON05', 'CX02', 'G104', 850000, N'DASUDUNG');
...
GO
INSERT INTO CHITIETDATVE (maCTDat, maDon, maChuyen, maGhe, giaVeLucDat, trangThaiVe) VALUES 
('CT14', 'DON08', 'CX35', 'G081', 850000, N'DASUDUNG'), -- Ghế P01 của xe 50E-802.84
('CT15', 'DON09', 'CX35', 'G082', 850000, N'DASUDUNG'),
('CT16', 'DON10', 'CX36', 'G103', 900000, N'DASUDUNG'), -- Ghế P01 của xe 51B-115.00
('CT17', 'DON11', 'CX36', 'G104', 900000, N'DASUDUNG'), -- Ghế P02 của xe 51B-115.00
('CT18', 'DON12', 'CX36', 'G105', 900000, N'DASUDUNG'), -- Ghế P03 của xe 51B-115.00
('CT19', 'DON13', 'CX37', 'G041', 750000, N'DASUDUNG'), -- Ghế A01 của xe 38B-012.42
('CT20', 'DON14', 'CX37', 'G042', 750000, N'DASUDUNG');
go
/* =============================================================
...
('TT07', 'DON08', 850000, N'CHUYENKHOAN', '2026-05-15 08:05', N'THANHCONG'),
('TT08', 'DON09', 850000, N'CHUYENKHOAN', '2026-05-15 09:35', N'THANHCONG'),
('TT09', 'DON10', 900000, N'TIENMAT',     '2026-05-16 10:05', N'THANHCONG'),
('TT10', 'DON11', 900000, N'CHUYENKHOAN', '2026-05-16 11:20', N'THANHCONG'),
('TT11', 'DON12', 900000, N'CHUYENKHOAN', '2026-05-16 14:25', N'THANHCONG'),
('TT12', 'DON13', 750000, N'TIENMAT',     '2026-05-17 09:05', N'THANHCONG'),
('TT13', 'DON14', 750000, N'CHUYENKHOAN', '2026-05-17 15:35', N'THANHCONG');
GO
/* =============================================================
   18. THÊM DỮ LIỆU ĐÁNH GIÁ (DANHGIA) CHO CX35, CX36, CX37
   Lưu ý: Ngày đánh giá được set sau ngày đi (18/05/2026)
============================================================= */
INSERT INTO DANHGIA (maDanhGia, maKH, maChuyen, diemDanhGia, binhLuan, ngayDanhGia) VALUES 
-- Đánh giá cho CX35 (Limousine 22 Phòng - Xe 50E-802.84)
('DG01', 'KH01', 'CX35', 5, N'Xe phòng nằm rất mới, rộng rãi và cực kỳ riêng tư. Bác tài chạy êm, ngủ một giấc là tới nơi.', '2026-05-19 08:30:00'),
('DG02', 'KH02', 'CX35', 4, N'Chất lượng xe tuyệt vời, đầy đủ tiện nghi. Trừ 1 sao vì máy lạnh trong cabin hơi buốt vào ban đêm.', '2026-05-19 10:15:00'),

-- Đánh giá cho CX36 (Cung điện di động - Xe 51B-115.00)
('DG03', 'KH03', 'CX36', 5, N'Đúng chuẩn cung điện di động! Nội thất sang trọng, wifi mạnh, màn hình giải trí xịn sò. Đáng đồng tiền bát gạo.', '2026-05-19 09:00:00'),
('DG04', 'KH04', 'CX36', 5, N'Nhà xe phục vụ chuyên nghiệp, phụ xe nhiệt tình hướng dẫn khách. Chỗ nằm êm ái, rất hài lòng.', '2026-05-19 11:45:00'),
('DG05', 'KH05', 'CX36', 4, N'Xe đẹp và sạch sẽ, đón khách đúng giờ. Sẽ tiếp tục ủng hộ nhà xe trong các chuyến tiếp theo.', '2026-05-20 07:20:00'),

-- Đánh giá cho CX37 (Giường nằm 40 chỗ - Xe 38B-012.42)
('DG06', 'KH06', 'CX37', 4, N'Xe giường nằm phổ thông chạy khá ổn định, giá vé hợp lý định. Tuy nhiên xe full chỗ nên hơi ồn ào một chút.', '2026-05-19 14:10:00'),
('DG07', 'KH07', 'CX37', 3, N'Xe chạy đúng tuyến nhưng mùi sáp thơm trên xe hơi gắt khiến mình bị say xe nhẹ. Điểm cộng là trạm dừng nghỉ đồ ăn ngon.', '2026-05-19 16:30:00');
GO
/* ==========================================================================================================================
...
/* =============================================================
   Cập nhật VIEW V_CHUYENXE - Thêm maTinhDi, maTinhDen
   để hỗ trợ tìm kiếm chính xác theo ID.
============================================================= */
CREATE OR ALTER VIEW V_CHUYENXE
AS
SELECT
    cx.maChuyen,
    cx.trangThai        AS trangThaiChuyen,
    bxdi.maBenXe        AS maBenDi,
    bxdi.tenBenXe       AS benDi,
    pxdi.tenPhuong      AS phuongDi,
    tdi.maTinh          AS maTinhDi,
    tdi.tenTinh         AS tinhDi,
    bxden.maBenXe       AS maBenDen,
    bxden.tenBenXe      AS benDen,
    pxden.tenPhuong     AS phuongDen,
    tden.maTinh         AS maTinhDen,
    tden.tenTinh        AS tinhDen,
    cx.ngayDi,
    cx.gioDi,
    cx.giaVe,
    x.loaiXe,
...
JOIN TUYENDUONG td ON cx.maTuyen   = td.maTuyen
JOIN BENXE bxdi     ON td.maBenDi   = bxdi.maBenXe
LEFT JOIN PHUONGXA pxdi  ON bxdi.maPhuongNo = pxdi.maPhuong
LEFT JOIN TINHTHANH tdi  ON pxdi.maTinhNo = tdi.maTinh
JOIN BENXE bxden    ON td.maBenDen  = bxden.maBenXe
LEFT JOIN PHUONGXA pxden ON bxden.maPhuongNo = pxden.maPhuong
LEFT JOIN TINHTHANH tden ON pxden.maTinhNo = tden.maTinh
JOIN XE x           ON cx.bienSo    = x.bienSo
JOIN NHAXE nx       ON x.maNhaXe    = nx.maNhaXe
WHERE cx.trangThai <> N'HUY';
GO

PRINT N'DA CAP NHAT VIEW V_CHUYENXE VOI MA TINH DI/DEN';
GO

-- 1. Xóa bỏ ràng buộc UNIQUE gây lỗi khi đặt lại ghế đã từng bị hủy
IF EXISTS (SELECT 1 FROM sys.objects WHERE name = 'UQ_GHE_CHUYEN' AND type = 'UQ')
BEGIN
    ALTER TABLE CHITIETDATVE DROP CONSTRAINT UQ_GHE_CHUYEN;
END
GO

-- 2. Cập nhật Stored Procedure SP_DatVe bản cải tiến cho SQL Server 2025 (dùng OPENJSON)
/* =============================================================
   Cập nhật Stored Procedure SP_DatVe bản cải tiến
   Hỗ trợ tham số người đi, KHÔNG sử dụng hậu tố _06
============================================================= */
CREATE OR ALTER PROCEDURE SP_DatVe
    @maKH NVARCHAR(50),
    @maChuyen NVARCHAR(50),
    @danhSachGhe NVARCHAR(MAX), -- JSON array: '["G01", "G02"]'
    @maKM NVARCHAR(50) = NULL,
    @ghiChu NVARCHAR(255) = NULL,
    @tenNguoiDi NVARCHAR(100) = NULL, -- Tham số mới (tuỳ chọn)
    @sdtNguoiDi VARCHAR(12) = NULL    -- Tham số mới (tuỳ chọn)
AS
BEGIN
    SET NOCOUNT ON;
    BEGIN TRY
        ...
        -- Lấy thông tin khách hàng mặc định
        DECLARE @tenKHMachDinh NVARCHAR(100);
        DECLARE @sdtKHMachDinh VARCHAR(15);
        SELECT @tenKHMachDinh = hoTen, @sdtKHMachDinh = sdt FROM KHACHHANG WHERE maKH = @maKH;

        -- Gán giá trị mặc định nếu ứng dụng không truyền thông tin người đi
        SET @tenNguoiDi = ISNULL(@tenNguoiDi, @tenKHMachDinh);
        SET @sdtNguoiDi = ISNULL(@sdtNguoiDi, @sdtKHMachDinh);

        -- 1. Đếm số lượng ghế
        DECLARE @soLuong INT;
        SELECT @soLuong = COUNT(*) FROM OPENJSON(@danhSachGhe);

        IF @soLuong > 7
        BEGIN
            RAISERROR(N'Không được đặt quá 7 ghế trong một lần.', 16, 1);
            ROLLBACK; RETURN;
        END

        -- 2. Kiểm tra xem các ghế có đang bị chiếm dụng không
        IF EXISTS (
            SELECT 1 
            FROM OPENJSON(@danhSachGhe) s
            JOIN CHITIETDATVE ct WITH (UPDLOCK) ON ct.maGhe = CAST(s.value AS NVARCHAR(50)) AND ct.maChuyen = @maChuyen
            WHERE ct.trangThaiVe IN (N'DADAT', N'DASUDUNG')
        )
        BEGIN
        ...
        -- 3. Xóa các bản ghi "DAHUY" cũ để tránh lỗi
        DELETE FROM CHITIETDATVE 
        WHERE maChuyen = @maChuyen 
          AND maGhe IN (SELECT CAST(value AS NVARCHAR(50)) FROM OPENJSON(@danhSachGhe))
          AND trangThaiVe = N'DAHUY';

        -- 4. Tính tổng tiền
        DECLARE @giaVe DECIMAL(12,0);
        SELECT @giaVe = giaVe FROM CHUYENXE WHERE maChuyen = @maChuyen;
        DECLARE @tongTien DECIMAL(12,0) = @giaVe * @soLuong;
        
        -- Áp dụng khuyến mãi nếu có
        IF @maKM IS NOT NULL
        BEGIN
            DECLARE @giaTriGiam DECIMAL(12,2), @loaiKM NVARCHAR(20);
            SELECT @giaTriGiam = giaTriGiam, @loaiKM = loaiKM FROM KHUYENMAI WHERE maKM = @maKM;
            IF @loaiKM = N'PHANTRAM' SET @tongTien = @tongTien * (1 - @giaTriGiam / 100);
            ELSE SET @tongTien = @tongTien - @giaTriGiam;
        END

        -- 5. Tạo mã đơn mới
        DECLARE @maDonMoi NVARCHAR(50) = 'DON_' + REPLACE(CONVERT(NVARCHAR(10), GETDATE(), 112), '/', '') + '_' + LEFT(REPLACE(CAST(NEWID() AS NVARCHAR(36)), '-', ''), 6);

        -- 6. Chèn vào bảng DONDATVE
        INSERT INTO DONDATVE (maDon, maKH, ngayDat, tongTien, trangThai, ghiChu, tienCoc, tennguoidi, sdtnguoidi)
        VALUES (@maDonMoi, @maKH, GETDATE(), @tongTien, N'CHOXULY', @ghiChu, 0, @tenNguoiDi, @sdtNguoiDi);

        -- 7. Chèn vào bảng CHITIETDATVE
        INSERT INTO CHITIETDATVE (maCTDat, maDon, maChuyen, maGhe, giaVeLucDat, trangThaiVe)
        SELECT 
            'CT_' + LEFT(REPLACE(CAST(NEWID() AS NVARCHAR(36)), '-', ''), 12),
            @maDonMoi, 
            @maChuyen, 
            CAST(value AS NVARCHAR(50)), 
            @giaVe, 
            N'DADAT'
        FROM OPENJSON(@danhSachGhe);

        COMMIT TRANSACTION;
        
        -- Trả về thông tin đơn mới để nhận diện thành công
        SELECT @maDonMoi AS MaDon, @tongTien AS TongTien;
    END TRY
    BEGIN CATCH
...
PRINT N'DA CAP NHAT SP_DatVe VOI OPENJSON VA FIX LOI UNIQUE CONSTRAINT';
GO

/* =============================================================
   TRIGGER / JOB: Tự động cập nhật trạng thái chuyến xe
   - SAPDI  → DANGDI    : khi đến ngày & giờ khởi hành
   - DANGDI → HOANTHANH : khi sang ngày hôm sau
   
   Vì SQL Server Trigger chỉ kích hoạt khi có DML (INSERT/UPDATE/DELETE),
   ta dùng SQL Server Agent Job (scheduled) hoặc SP gọi từ Java Timer.
   File này cung cấp:
   1. SP_CapNhatTrangThaiChuyen — Stored Procedure thực hiện cập nhật
   2. Hướng dẫn tạo SQL Server Agent Job chạy mỗi phút
   3. Trigger hỗ trợ kiểm tra trước khi đặt vé
============================================================= */

/* ─────────────────────────────────────────────────────────────
   1. STORED PROCEDURE: SP_CapNhatTrangThaiChuyen
   Gọi định kỳ (mỗi 1 phút qua SQL Agent Job)
───────────────────────────────────────────────────────────── */
CREATE OR ALTER PROCEDURE SP_CapNhatTrangThaiChuyen
AS
BEGIN
    SET NOCOUNT ON;
    ...
    -- 1. SAPDI → DANGDI: ngày giờ khởi hành đã đến hoặc đã qua
    UPDATE CHUYENXE
    SET trangThai = N'DANGDI'
    WHERE trangThai = N'SAPDI'
      AND CAST(ngayDi AS DATETIME) + CAST(gioDi AS DATETIME) <= @now;

    -- 2. DANGDI → HOANTHANH: thời gian khởi hành + thoiGianDuKien <= @now
    UPDATE cx
    SET cx.trangThai = N'HOANTHANH'
    FROM CHUYENXE cx
    INNER JOIN TUYENDUONG tx ON cx.maTuyen = tx.maTuyen
    WHERE cx.trangThai = N'DANGDI'
      AND DATEADD(minute, tx.thoiGianDuKien, CAST(cx.ngayDi AS DATETIME) + CAST(cx.gioDi AS DATETIME)) <= @now;

    -- (Tuỳ chọn) Log số lượng cập nhật
    -- PRINT N'Da cap nhat ' + CAST(@@ROWCOUNT AS NVARCHAR) + N' chuyen xe';
END;
GO

PRINT N'Da tao SP_CapNhatTrangThaiChuyen';
GO

CREATE OR ALTER TRIGGER TRG_CHUYENXE_AFTER_INSERT_UPDATE
ON CHUYENXE
AFTER INSERT, UPDATE
AS
BEGIN
    ...
    -- Tự động chuyển SAPDI → DANGDI nếu ngày giờ đã đến
    UPDATE cx
    SET cx.trangThai = N'DANGDI'
    FROM CHUYENXE cx
    INNER JOIN INSERTED i ON i.maChuyen = cx.maChuyen
    WHERE cx.trangThai = N'SAPDI'
      AND CAST(cx.ngayDi AS DATETIME) + CAST(cx.gioDi AS DATETIME) <= GETDATE();

    -- Tự động chuyển DANGDI → HOANTHANH nếu đã đến giờ đến
    UPDATE cx
    SET cx.trangThai = N'HOANTHANH'
    FROM CHUYENXE cx
    INNER JOIN INSERTED i ON i.maChuyen = cx.maChuyen
    INNER JOIN TUYENDUONG tx ON cx.maTuyen = tx.maTuyen
    WHERE cx.trangThai = N'DANGDI'
      AND DATEADD(minute, tx.thoiGianDuKien, CAST(cx.ngayDi AS DATETIME) + CAST(cx.gioDi AS DATETIME)) <= GETDATE();
END;
GO

PRINT N'Da tao Trigger TRG_CHUYENXE_AFTER_INSERT_UPDATE';
GO

PRINT N'=== HOAN THANH: Da tao day du trigger va stored procedure ===';
PRINT N'Chu y: De SP_CapNhatTrangThaiChuyen chay tu dong moi phut,';
PRINT N'       can tao SQL Server Agent Job (xem comment trong file nay).';
GO
